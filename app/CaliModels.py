...
CalibratorList = {
    ...
    'CasA': [(23 + 23./60. + 26.93/60.**2)*15, 58 + 49/60. + 7.68/60.**2],
...
def distance_to_jupiter(mjd, longitude, latitude):
...
# Example usage:
mjd = 59000  # Example MJD
longitude = -105.820417  # Example longitude (for Ma
...
def JupiterFlux(nu, mjd, lon=0, lat=0, source='jupiter',allpos=False,return_jansky=False):
    ...
    dist = distance_to_jupiter(mjd, lon, lat)
...
class JupiterFluxModel:
    ...
    def karim2014(self,nu,mjd=51544, lon=comap_longitude, lat=comap_latitude, source='jupiter',allpos=False,return_jansky=False,**kwargs):
        """
        args:
        nu - in GHz
        mjd - 
